...
export default async function Page() {
  try {
    const [groupRes, branchRes, classesRes] = await Promise.all([
      fetch(`${process.env.NEXT_PUBLIC_SERVER_V1}/group`, { cache: "no-store" })
      ...
      fetch(`${process.env.NEXT_PUBLIC_SERVER_V1}/class`, { cache: "no-store" })
