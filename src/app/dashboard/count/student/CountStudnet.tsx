...
export default function CountStudent() {
  ...
  const fetchInstitutions = async (searchText: string) => {
    try {
  ...
  useEffect(() => {
    if (selectedExam && selectedInstitution) {
      fetchStudentsForExam(selectedExam);
    } else {
      setStudents([]);
    }
  }, [selectedExam, selectedInstitution]);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="col-span-1 relative">
            ...
            <div className="relative">
              <div className="absolute top-2.5 inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  institutions.map((institution) => (
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-500">
                        {institution.branch.name} - {institution.pin}
                      </div>
                    </div>
                  ))
                ) : (
          ...
          <div className="col-span-1">
            ...
            <select
              ...
              disabled={!selectedExam || !selectedInstitution}
            >
        ...
        {fetchingStudents ? (
        ...
        ) : selectedExam && selectedInstitution && students.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500">
              No students found for this exam and institution
            </p>
          </div>
        ) : (
          <div className="text-center py-12">
